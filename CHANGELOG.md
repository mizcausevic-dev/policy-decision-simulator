...
### Released
- Published **policy-decision-simulator** as a public, portfolio-grade platform governance system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **policy-decision-simulator**.
...
- That insight became the basis for **policy-decision-simulator**.
